...
export const SecurityPage: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
          ...
          <div className="flex items-center justify-between px-4 py-3 bg-slate-50 border border-brand-border rounded-xl">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-brand-slate">{twoFA ? 'Enabled — require a code on sign-in' : 'Currently disabled'}</p>
              </div>
            </div>
      ...
      {/* Active sessions */}
      <SectionCard title="Login Sessions" subtitle="Devices currently signed in to your account" action={<GhostButton className="text-xs">Sign out all</GhostButton>}>
            ...
            <div key={s.id} className="flex items-center justify-between px-4 py-3 border border-brand-border rounded-xl">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-brand-slate">{s.location} · {s.lastActive}</p>
                </div>
              </div>
