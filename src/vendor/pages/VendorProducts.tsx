    ...
    <div className="space-y-5">
      ...
      {modal && (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
          <form onSubmit={addProduct} className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl space-y-4">
            ...
            <div className="flex gap-2">
              <button type="button" onClick={() => setModal(false)} className="flex-1 py-2 border rounded-xl text-sm" disabled={uploading}>Cancel</button>
